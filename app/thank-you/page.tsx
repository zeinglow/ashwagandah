    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-600">جاري تحميل تأكيد طلبك...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-700 mb-6">
            رحلتك نحو <span className="font-bold text-emerald-600">الهدوء اليومي والنوم العميق</span> تبدأ الآن!
          </p>
          
          <div className="bg-gradient-to-r from-emerald-100 to-green-100 border border-emerald-200 rounded-3xl p-6 inline-block">
            <div className="text-sm text-emerald-700 font-semibold mb-1">رقم الطلب</div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl border border-emerald-100 overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-emerald-500 to-green-600 text-white p-6 text-center">
            ...
            <p className="text-emerald-100 mt-1">سنتصل بك خلال 24 ساعة لتأكيد تفاصيل التوصيل</p>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-bold text-slate-900 mb-3">معلومات العميل</h3>
                <div className="space-y-2 text-sm">
                  <div><span className="text-slate-600">الاسم:</span> <span className="font-medium">{orderData.name}</span></div>
                  <div><span className="text-slate-600">البريد الإلكتروني:</span> <span className="font-medium">{orderData.email}</span></div>
                  <div><span className="text-slate-600">الهاتف:</span> <span className="font-medium">{orderData.phone}</span></div>
                  <div><span className="text-slate-600">تاريخ الطلب:</span> <span className="font-medium">{orderData.orderDate}</span></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-200">
                  ...
                  <div className="text-sm text-slate-600 mb-3">
                    {orderData.bundle.gummies} حبة • مخزون {orderData.bundle.days} يوم
                  </div>
                  <div className="border-t border-emerald-200 pt-3 flex justify-between items-center">
                    <span className="font-bold text-lg">المجموع (دفع عند الاستلام):</span>
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-emerald-100 p-8 mb-8">
          <h2 className="text-2xl font-bold text-center text-slate-900 mb-8">ماذا يحدث بعد ذلك؟</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-bold text-slate-900 mb-2">سنتصل بك</h3>
              <p className="text-sm text-slate-600">فريقنا سيتصل بك خلال 24 ساعة لتأكيد طلبك وعنوان التوصيل.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-slate-900 mb-2">توصيل سريع</h3>
              <p className="text-sm text-slate-600">حلوى زينغلو ستصل إلى باب منزلك خلال 2-3 أيام عمل.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="font-bold text-slate-900 mb-2">ابدأ رحلتك</h3>
              <p className="text-sm text-slate-600">تناول حبتين يوميًا واشعر بذوبان التوتر. نتائج في 1-2 أسبوع!</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-3xl p-8 mb-8 text-center shadow-2xl">
          ...
          <h2 className="text-2xl font-bold mb-4">عرض حصري: وفر 25% على طلبك التالي!</h2>
          <p className="text-amber-100 mb-6">
            بما أنك أصبحت الآن جزءًا من عائلة زينغلو، نعطيك وصولاً مبكرًا لإعادة الطلب بسعر خاص.
          </p>
          
          <div className="bg-white/20 backdrop-blur rounded-2xl p-4 mb-6">
            <div className="text-sm font-semibold mb-1">استخدم الرمز:</div>
        ...
        <div className="bg-red-50 border border-red-200 rounded-3xl p-6 text-center mb-8">
          <h3 className="font-bold text-red-800 mb-2">⏰ ينتهي تأكيد طلبك خلال:</h3>
          <div className="text-3xl font-extrabold text-red-600 font-mono">
            {formatTime(timeLeft)}
          </div>
          <p className="text-sm text-red-700 mt-2">
            يرجى إبقاء هاتفك متاحًا لمكالمة التأكيد
          </p>
        </div>

        {/* Social Sharing */}
        <div className="bg-white rounded-3xl shadow-xl border border-emerald-100 p-8 text-center">
          <h2 className="text-xl font-bold text-slate-900 mb-4">شارك رحلتك نحو العافية</h2>
          <p className="text-slate-600 mb-6">
            ساعد أصدقاءك وعائلتك على اكتشاف الراحة التي يستحقونها!
          </p>
        ...
        <div className="mt-12 text-center bg-emerald-50 rounded-3xl p-6 border border-emerald-200">
          <h3 className="font-bold text-emerald-800 mb-3">هل تحتاج مساعدة؟</h3>
          <p className="text-emerald-700 mb-4">
            فريق الدعم لدينا هنا لمساعدتك في كل خطوة على الطريق.
          </p>
          <div className="space-y-2 text-sm text-emerald-600">
            <div>📧 البريد الإلكتروني: support@zeinglow.com</div>
            <div>📱 واتساب: <span dir="ltr">+971 50 341 21 74</span></div>
            <div>🕒 متوفر: الأحد - الخميس، 9 صباحًا - 6 مساءً</div>
          </div>
        </div>
